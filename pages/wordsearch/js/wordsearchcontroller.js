...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		"Reactions!": [["oxidation", "reduction", "combustion", "hydrolysis"],
			["substitution", "addition", "elimination", "polymerization"],
			["precipitation", "neutralization", "fermentation", "esterification"],
			["displacement", "acidbase", "enzymatic", "photochemical"],
			["chainreaction", "catalysis", "redox", "stoichiometry"]],
		
		"Biochem!": [["replication", "synthesis", "glycolysis", "Krebs"],
			["transport", "amino", "carbs", "lipids"],
			["nucleic", "enzymes", "coenzymes", "vitamins"],
			["hormones", "metabolism", "signaling", "bioenergetics"],
			["expression", "respiration", "phosphorylation", "glycogenesis"]]
	};
